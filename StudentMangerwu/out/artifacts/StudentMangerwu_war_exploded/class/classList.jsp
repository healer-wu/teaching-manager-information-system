    ...
    <script type="text/javascript">
        $(function() {
            ...
            $('#dataList').datagrid({
                ...
                fit: true,//自动大小
                method: "post",
                url:"classservlet?method=getClazzList&t="+new Date().getTime(),
                idField:'id',
            ...
            $("#delete").click(function(){
                ...
                if(selectRow == null){
                    ...
                    $.messager.confirm("消息提醒", "将删除班级相关信息（如果班级下有老师或学生，则不能删除），确认继续？", function(r){
                        if(r){
                            $.ajax({
                                type: "post",
    ...
    <form id="addForm" method="post">
        <table cellpadding="8" >
            ...
            <tr>
                <td>专业 :</td>
                <td>
                    <textarea id="info" name="info" style="width: 200px; height: 30px;"  type="text"></textarea>
                </td>
            </tr>
        </table>
    </form>
