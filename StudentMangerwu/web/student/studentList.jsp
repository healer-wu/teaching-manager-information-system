        ...
        $(function() {
            ...
            $('#dataList').datagrid({
                ...
                columns: [[
                    ...
                    {field:'class_id',title:'班级',width:150,
...
<%--    <div style="float: left; margin: 0 10px 0 10px">年级：<input id="gradeList" class="easyui-textbox" name="grade" /></div>--%>
    ...
    <div style="margin-top: 3px">&nbsp;&nbsp;班级：<input id="clazzList" class="easyui-textbox" name="clazz" />
...
<div id="addDialog" style="padding: 10px">
    ...
    <form id="addForm" method="post">
        <table cellpadding="8" >
            ...
            <tr>
                <td>班级:</td>
                <td><input id="add_clazzList" style="width: 200px; height: 30px;" class="easyui-textbox" name="class_id" /></td>
            </tr>
        </table>
    </form>
</div>
    ...
    <form id="editForm" method="post">
        ...
        <table cellpadding="8" >
            <tr>
                <td>学号:</td>
                <td>
                    <input id="edit_number" data-options="readonly: true" class="easyui-textbox" style="width: 200px; height: 30px;" type="text" name="sn" data-options="required:true, validType:'repeat', missingMessage:'请输入学号'" />
                </td>
            </tr>
            <tr>
                <td>姓名:</td>
