    ...
    <script type="text/javascript">
        $(function () {
            ...
            $("#vcodeImg").click(function () {
                this.src = "checkcodeservlet?method=loginCapcha&t=" + new Date().getTime();
            });
            ...
            <div class="row cl">
                <div class="formControls col-8 col-offset-3">
                    <input class="input-text size-L" name="vcode" type="text" placeholder="请输入验证码"
                           style="width: 200px;">
                    <img title="点击图片切换验证码" id="vcodeImg" src="checkcodeservlet?method=loginCapcha"></div>
            </div>
...
<div class="footer">Copyright &nbsp; wky @ wu</div>
