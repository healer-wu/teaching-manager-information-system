...
<div id="toolbar">
    ...
    <div style="float: left;" class="datagrid-btn-separator"></div>
    <div style="float: left;margin-top: 4px">课程名称：<input id="courseName" class="easyui-textbox" name="clazzName" /></div>
    <div style="margin-top: 3px">授课老师：<input id="teacherList" class="easyui-textbox" name="clazz" />
...
<div id="editDialog" style="padding: 10px">
    <form id="editForm" method="post">
        ...
        <table cellpadding="8" >
            ...
            <tr>
                <td>上课时间:</td>
                <td><input id="edit_course_date" style="width: 200px; height: 30px;" class="easyui-textbox" type="text" name="courseDate" data-options="required:true, missingMessage:'不能为空'" /></td>
            </tr>
            <tr>
                <td>最多可选人数:</td>
                <td><input id="edit_max_num" style="width: 200px; height: 30px;" class="easyui-numberbox" type="text" name="maxNum" data-options="min:0,precision:0,required:true, missingMessage:'不能为空'" /></td>
            </tr>
            <tr>
                <td>课程介绍:</td>
                <td>
