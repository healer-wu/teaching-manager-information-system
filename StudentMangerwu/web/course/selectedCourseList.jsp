								...
								$.ajax({
									...
									success: function(msg){
										if(msg == "success"){
											...
											$.messager.alert("消息提醒","课程已满!","warning");
											return;
										}else if(msg=="isSelected"){
											$.messager.alert("消息提醒","你已选该课程，不能再选！","warning");
											return;
										}else{
...
<%--	<div style="float: left;" class="datagrid-btn-separator"></div>--%>
	...
	<div style="float: left;" class="datagrid-btn-separator"></div>
	<div style="float: left;margin-top: 4px">学生：<input id="studentList" class="easyui-textbox" name="studentList" /></div>
	<div style="margin-top: 3px">课程：<input id="courseList" class="easyui-textbox" name="courseList" />
...
<div id="addDialog" style="padding: 10px">
	<form id="addForm" method="post">
		<table cellpadding="8" >
			<tr>
				<td>学生:</td>
				<td><input id="add_studentList" style="width: 200px; height: 30px;" class="easyui-textbox" type="text" name="studentId" data-options="required:true, missingMessage:'不能为空'" /></td>
			</tr>
			<tr>
				<td style="width:40px">选课信息:</td>
				<td colspan="3">
